...
import { createFood, getAll, getOne, remove, search, update, updateItemDiscounts } from "../controller/FoodController.js";
...
router.put("/discounts/bulk", VerifyToken, VerifyAdmin, updateItemDiscounts);
